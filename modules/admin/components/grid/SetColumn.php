...
class SetColumn extends DataColumn
{
    ...
    protected function renderDataCellContent($model, $key, $index) // Рендеринг содержимого ячейки данных
    {
     ...
     * @return string
     */
    private function getStatusName($model, $key, $index, $value) // Получить название статуса
    {
        if ($this->name !== null) {
